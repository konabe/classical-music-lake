...
| 日付       | バージョン | 変更内容                                                                                                                                                                                                                                                                                                  |
| ---------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-05 | 1.9.0      | コンサート記録機能を追加（`POST /concert-logs`・`GET /concert-logs` エンドポイント新設、DynamoDB テーブル `classical-music-concert-logs` 追加、`ConcertLog`・`CreateConcertLogInput` 型定義追加、`useConcertLogs` composable・関連コンポーネント群を追加、TOPページにコンサート記録メニューカードを追加） |
